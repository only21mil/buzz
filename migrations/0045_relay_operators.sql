...
-- Fork 0039 expanded moderation_actions_action_check vocabulary must survive
-- adoption of upstream 0035 column amendments (upstream does not touch the
-- CHECK; re-assert so mixed-version apply paths cannot narrow the fork set).
