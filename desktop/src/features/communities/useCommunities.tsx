...
import { removeMessageSnapshotsForIdentity } from "@/features/messages/lib/messageSnapshot";
...
export type UseCommunitiesReturn = {
  ...
  removeCommunity: (id: string, signerPubkey: string) => void;
