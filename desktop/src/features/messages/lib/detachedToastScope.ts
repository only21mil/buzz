 ...
 *
 * Callers must register the applied shell scope and run the returned cleanup
 * when it unmounts or changes identity. Community reset also clears the mirror. The
