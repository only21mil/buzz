...
fn build_profile_event(
    ...
    let builder = append_verified_auth_tag(builder, agent_keys, auth_tag_json)?;
...
// ── Managed-agent directory record maintenance ──────────────────────────────

mod agent_directory;
use agent_directory::append_verified_auth_tag;
pub use agent_directory::sync_managed_agent_profile_directory;
