//! Built-in runtime launch contracts.
use super::*;
...
pub(crate) const KNOWN_ACP_RUNTIMES: &[KnownAcpRuntime] = &[
    KnownAcpRuntime {
        ...
        effort_normalization: Some(&runtime_metadata::GOOSE_EFFORT_NORMALIZATION),
    ...
    KnownAcpRuntime {
        ...
        effort_normalization: None,
        effort_accepted_values: Some(runtime_metadata::BUZZ_AGENT_EFFORT_VALUES),
