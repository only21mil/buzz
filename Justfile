...
admin: _require-relay-key bootstrap _ensure-migrations
    ...
    # Preserve the authenticated default; disabled mode requires an explicit
    # operator choice and a separately enforced network boundary.
    export BUZZ_ADMIN_AUTH="${BUZZ_ADMIN_AUTH:-nip98}"
