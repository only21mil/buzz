...
INSERT INTO expected_migration_lineage VALUES
    ...
    (1029, 'workflow run snapshots', decode('b6dbaff039468e45d73c271837ab101cd9159ef7beb0a7d62b49e962936e47919f5846c3075f9acb4ecf35a9de754608', 'hex')),
    (1030, 'workflow state', decode('dcead8897d24e149f49204e50d5288128ec5a85824e5e2f03f0e29639b1df3660b23ace520416c833c4b20789ff13052', 'hex')),
    (1031, 'workflow approval foundations', decode('d0387fe23f3ce73b265b292d2c316b792ad91ad5519ccd7cb7614a0823fda35f7f2250134fb8250e548089f391d67292', 'hex')),
    (1032, 'ci event storage', decode('0312074fb427b702a5c5f370e7b06ad15ec51c6488f040d545e64f5f6b7a6ed11f9ba84395b2ba963d6d83aa5f1faeaf', 'hex')),
    (1033, 'workflow resume recovery', decode('c43fd9e80d84ceb16bbbacb27a037d2feab87919f0c2097405c848a201084fbadc01cfe2b9a741a71072060dd84da5aa', 'hex')),
    (1034, 'workflow effect claims', decode('98c1b5b0d5432b298afa00f83f50a0d27902e929955702a3426e6774c6a7331744885ecbec8a3d188e2baae7eef0d831', 'hex')),
    (1035, 'ci grants', decode('09467f5a17e44e8931088c2b2eda81e963ceeebd3ba588940ab8f910df9a2a385bc867a2c4cd8ba4fadd3165276bb08d', 'hex')),
    (31, 'workflow run error codes', decode('28a5aac2e1a6a4b7c7de4c61d760f5e132e511f085b4a952539df22d0835689d72b6231be2ffaa44e154d987646a40ff', 'hex')),
    (40, 'push message kinds', decode('d2247d99141ee99c5da55a973d9810c68e2a2566abd0b1e894312deb9e5ccad7d5b393f2c1d4b2736f3a7e0980252c6f', 'hex')),
    (43, 'push gateway dogfood profile', decode('ed55cbda5e3de7e5306b84481399e62b01ff88798f1b708d2d1614d4d9296f5babec17082339944f3eb7b9d8e26e5e7c', 'hex')),
    (1039, 'channel admin audit actions', decode('2eb0a56da293cc9d85c246abf18601ecc5d64a8471a38e77ff1c10ab6f769ab8ff69bb1399d99dedd352070dcfaef30e', 'hex')),
    (1040, 'agent drafts', decode('af619357f88765157a151571825319af5218860d4a51d9a733ff0cee518def67910fda7a7d1f426e0ddab1fd0d5b543f', 'hex')),
    (1041, 'ci check storage', decode('fbc4fed76e4f67365b90c87017e04c05f03fec16b4e7912db5df7ae2fb7f83e599b5aa87d5f09366f722fe3c462849fd', 'hex')),
    (1042, 'ci merge gate', decode('953c4b11335c54b6dcd44aff642518f2f75bdb6bc2466e1690e8fb2451302b8a634b9c9d99fd5650f48e8d4ac749aa90', 'hex'));
DO $$ BEGIN
    ...
    END IF;
END $$;
UPDATE _sqlx_migrations SET version = 38 WHERE version = 43;
UPDATE _sqlx_migrations SET version = 37 WHERE version = 40;
UPDATE _sqlx_migrations SET version = 36 WHERE version = 31;
UPDATE _sqlx_migrations SET version = version - 1000 WHERE version IN (1029,1030,1031,1032,1033,1034,1035,1039,1040,1041,1042);
DO $$ BEGIN
    IF EXISTS (
        SELECT 1 FROM (
            SELECT CASE version WHEN 1029 THEN 29 WHEN 1030 THEN 30 WHEN 1031 THEN 31 WHEN 1032 THEN 32 WHEN 1033 THEN 33 WHEN 1034 THEN 34 WHEN 1035 THEN 35 WHEN 1039 THEN 39 WHEN 1040 THEN 40 WHEN 1041 THEN 41 WHEN 1042 THEN 42 WHEN 31 THEN 36 WHEN 40 THEN 37 WHEN 43 THEN 38 ELSE version END AS version, description, checksum FROM expected_migration_lineage
