...
def validate_assets(package: Path, entries: list[Entry]) -> None:
    ...
    required_service = {
        ...
        "ReadOnlyPaths=/etc/buzzci/controld-v1.json -/var/lib/buzzci/activation-controller/controld-acceptance-v1.json -/run/buzzci/runner-control.sock -/run/buzzci/keyholder.sock",
