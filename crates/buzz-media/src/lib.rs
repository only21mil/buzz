...
pub use config::{MediaConfig, S3AddressingStyle, DEFAULT_MAX_GIF_BYTES, DEFAULT_MAX_IMAGE_BYTES};
...
pub use validation::{
    looks_like_iso_bmff, serve_inline, validate_video_file, VideoMeta, MAX_IMAGE_DECODE_BYTES,
    MAX_IMAGE_PIXELS,
};
