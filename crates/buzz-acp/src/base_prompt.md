...
- For a notifying `@mention`, use the person's **exact display name as shown in Buzz**. Do not infer a surname or look for a fuller name. Partial names fail silently.
