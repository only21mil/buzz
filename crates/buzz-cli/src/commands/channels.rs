...
mod tests {
    ...
    use super::{
        ...
        channel_members_with_authority, cmd_set_add_policy, extract_channel_metadata,
        fetch_candidate_hints, finalize_roster_resolution, format_candidate, hints_from_results,
        include_channel, is_channel_archived, join_bounded_queries, merge_agent_profile_policy,
        name_matches, query_list_channel_events, resolve_roster_with_archive_filter,
